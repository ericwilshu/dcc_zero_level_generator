...
BLANK_SHEET = "templates/char_sheet_blank.svg"
...
if __name__ == "__main__":
    ...
    data = getDataFiles("data_files/")
    myChar = character_generator2.dccZeroLevelChar(data, True, True, True, True, True)
    myCharSheet = writeSVG(myChar)

    #print(et.tostring(myCharSheet))

    file = open('static/new_sheet.svg', 'w')
    file.write(et.tostring(myCharSheet, encoding='unicode'))
    file.close()

    s2p(url='static/new_sheet.svg', write_to='static/new_sheet.pdf')
